...
<footer class="footer">
    ...
    <div class="container">
        ...
        <img src="<?= get_template_directory_uri() ?>\images\footer-rightside.png" alt=""></div>
        ...
        <div class="footer-socials">
            <div class="footer-facebook"><a href="https://www.instagram.com/studiobesasg/"><img src="<?= get_template_directory_uri() ?>\images\facebook.png" alt=""></a></div>
            <div class="footer-instagram"><a href="https://www.facebook.com/studiobesasg"><img src="<?= get_template_directory_uri() ?>\images\instagram.png" alt=""></a></div>
        </div>
 ...
 By<a href="https://www.adits.ch">Adits</a></div>
</footer>
<?php
wp_footer();
?>
